...
let history_sub_screen = new SubScreen(document, "history_subcontent_title", "sub-nav-button-history", "sub-nav-button-small-history", history_sub_screen_names, history_sub_screen_containers, 0);
...
let history_temporary_alerts = new TemporaryAlert(document, "history_subcontent_div", "history_content");
