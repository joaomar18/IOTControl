...
let consumption_sub_screen = new SubScreen(document, "consumption_subcontent_title", "sub-nav-button-consumption", "sub-nav-button-small-consumption", consumption_sub_screen_names, consumption_sub_screen_containers, 0);
...
let consumption_temporary_alerts = new TemporaryAlert(document, "consumption_subcontent_div", "consumption_content");
