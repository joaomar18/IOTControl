...
let history_sub_screen_names = ["Proteção e Limitação", "Controlo de Carga", "Conexão"];
let history_sub_screen_containers = ["protection_history_content", "activation_history_content", "connection_history_content"];
