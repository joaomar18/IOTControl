...
async def main(): #Main coroutine
    ...
    data.ws.ws_server = ws.WebsocketsServer("192.168.1.79", 9001, data.queues.ws_server_send_queue, data.general.main_loop) #initializes a websockets server on localhost, port 9001 and passes it it's message queue to send
